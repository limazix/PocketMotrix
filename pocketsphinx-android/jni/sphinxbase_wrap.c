...
SWIGEXPORT jint JNICALL Java_edu_cmu_pocketsphinx_SphinxBaseJNI_FsgModel_1addSilence(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jstring jarg2, jint jarg3, jint jarg4) {
  jint jresult = 0 ;
  FsgModel *arg1 = (FsgModel *) 0 ;
  char *arg2 = (char *) 0 ;
  int arg3 ;
...
SWIGEXPORT jlong JNICALL Java_edu_cmu_pocketsphinx_SphinxBaseJNI_Jsgf_1iter(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jlong jresult = 0 ;
  Jsgf *arg1 = (Jsgf *) 0 ;
  JsgfIterator *result = 0 ;
